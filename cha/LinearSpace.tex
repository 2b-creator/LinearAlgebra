...
类比于直线的向量表示，设向量$x,x_1,a,b\in \mathbb{R}^3$，$P,P_1,P_2,P_3$点在平面上，令$x=\overrightarrow{OP},a=\overrightarrow{P_1P_2},b=\overrightarrow{P_1P_3},x_1=\overrightarrow{OP_1}$，设$t,s\in \mathbb{R}$，对于任意处于平面上的$P$点，总存在$t,s$使得$x=\overrightarrow{OP}$满足$$x=x_1+ta+sb$$